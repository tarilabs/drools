 ...
 * of a process's action scripts, conditions scripts, and rules. To make the life of the script programmer easier.
 * This class will be automatically imported by the platform when process script, and rules, related classes are
