...
public class KieModuleIncrementalCompilationTest {
    ...
    @Test
    public void checkIncrementalCompilationWithDMNImports() {
        String dmn1 = "<?xml version=\"1.0\" ?>\n" +
        ...
        kfs.write("src/main/resources/org/kie/scanner/dmn1.dmn", dmn1);
        KieBuilder kieBuilder = ks.newKieBuilder(kfs).buildAll();
        assertEquals(0,
                     kieBuilder.getResults().getMessages(org.kie.api.builder.Message.Level.ERROR).size());

        kfs.write("src/main/resources/org/kie/scanner/dmn2.dmn", dmn2);
